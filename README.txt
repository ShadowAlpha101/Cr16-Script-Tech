...
This is desiged to provide an application through which both the client and the employees of the company can login, 
...
Procedure:
1.) Install the flask_mail, flask_session and flask through pip from command prompt which you can access on your desktop.
2.)Run main.py 
